...
inline constexpr int OPEN=101,NETWORK=102,LOCATE=103,FULLVLC=104,COMPARE=105,CLOSECOMPARE=106,SNAPSHOT=107,DIAGNOSTICS=108,FULLSCREEN=109,
 ...
 SUBFILE=120,AUDIODELAY=121,SUBDELAY=122,FRAME=123,ABOUT=124,DLSS=125,CLEAR=126,REMOVE=127,SAVEQUEUE=128,CHAPTERPREV=129,CHAPTERNEXT=130,VSR=131,CINEMA=132,TOPMOST=133,JUMP=134,BOOKMARK=135,MEDIAINFO=136,NR=137,QUEUEUP=138,QUEUEDOWN=139,
 SEEK=201,VOLUME=202,RATE=203,QUEUE=204,FXENABLE=205,CONTRAST=206,BRIGHTNESS=207,SATURATION=208,GAMMA=209,RESETFX=210,
 AUDIOFIRST=4000,SUBFIRST=5000,EQFIRST=6000,CHAPTERFIRST=7000,ASPECTFIRST=8000,CROPFIRST=8100,DEINTFIRST=8200,BOOKMARKFIRST=9000,DEVICEFIRST=10000;
...
struct Window {
 ...
 HFONT font=nullptr,titleFont=nullptr; HMENU audioMenu=nullptr,subMenu=nullptr,eqMenu=nullptr,chapterMenu=nullptr,bookmarkMenu=nullptr,deviceMenu=nullptr;
 std::vector<HWND> controls;std::vector<std::pair<int,std::wstring>> audioTracks,subTracks;
 std::vector<int64_t> bookmarks;std::vector<std::string> audioDevices;std::unique_ptr<NeuralPanel> neural;bool cinema=false,topmost=false;
 ...
 void move(int,int,int,int,int);void message(const std::wstring&);void failure(const std::exception&);
