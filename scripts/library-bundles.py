...
out, package, first, second, third = map(Path, sys.argv[1:])
out.parent.mkdir(parents=True, exist_ok=True)
identities = []
for version, dll in [('1.0.0', first), ('1.1.0', second), ('1.2.0', third)]:
    data = dll.read_bytes()
    manifest = {
...
out.write_text('// Generated from the three first-party binaries in this build.\n#pragma once\n'
